...
const FEATURE_CATEGORIES: FeatureCategory[] = [
  ...
  {
    id: "food-management",
    title: "🍽️ Mutfak Gıdaları",
    description: "Türk, İtalyan, Fransız ve daha fazla mutfak",
    icon: "🍽️",
    route: "/food-management-categorized",
  },
  {
    id: "dietitian-recommendations",
    title: "💡 Diyetisyen Önerileri",
    description: "Diyetisyeninizden gelen öneri ve uyarılar",
    icon: "💡",
    route: "/dietitian-recommendations",
  },
  {
    id: "meal-plan-templates",
    title: "📋 Öğün Plan Şablonları",
    description: "Hazır öğün planları ve şablonlar",
    icon: "📋",
    route: "/meal-plan-templates",
  },
  {
    id: "nutrition-report",
    title: "📄 Beslenme Raporu",
    description: "Detaylı beslenme analiz raporu",
    icon: "📄",
  ...
  },
  {
    ...
    description: "Haftalık ilerleme ve özet raporları",
    icon: "📅",
  ...
  },
  {
    ...
    description: "Kişisel sağlık hedeflerinizi belirleyin",
    icon: "🎯",
    route: "/health-goals",
  },
  {
    id: "micronutrient-tracking",
    title: "🔬 Mikro Besin Takibi",
    description: "Vitamin ve mineral takibi",
    icon: "🔬",
  ...
  },
  {
    id: "messaging",
    title: "💬 Mesajlaşma",
    description: "Diyetisyeninizle direkt iletişim",
    icon: "💬",
    route: "/messaging",
  },
  {
    ...
    title: "📹 Video Danışma",
    description: "Görüntülü danışma seansları",
    icon: "📹",
  ...
  },
  {
    ...
    description: "Son aktiviteler ve güncellemeler",
    icon: "📢",
    route: "/activity-feed",
  },
  {
    id: "client-health-data",
    title: "🩺 Danışan Sağlık Verileri",
    description: "Boy, kilo, hastalık ve sağlık kartları",
    icon: "🩺",
    route: "/client-health-data",
  },
  {
    id: "dietitian-notes",
    title: "📝 Danışma Notları",
    description: "Danışma sonrası not al ve danışana gönder",
    icon: "📝",
    route: "/dietitian-notes",
  },
  {
    id: "goals",
    title: "🎯 Hedef Takibi",
